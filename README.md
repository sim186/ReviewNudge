...
- [Why am I getting this notification?](docs/notification-logic.md)
- [Warnings](#warnings)
...
For every open, non-draft merge request in the configured groups, ReviewNudge evaluates
who has an action to take. It does not notify someone merely because they appear in the
merge request’s participant list. See the dedicated [notification logic guide](docs/notification-logic.md)
for the recipient-facing explanation.
